...
c open files
c
      print *, 'Welcome to fpfit!  This version of fpfit finds the'
...
115   fname1 = aask('Name of file with list of trial mechanisms',
     1     '/Seis/S/we/src/fpfit/src/ptm10.dat', -80)
...
12    ftemp = aask('Name of fpfit control file', 
     &             '/Seis/S/we/src/fpfit/src/fpfit.ctl', -80)
      call openit('read', ftemp, cunit, ierr)
      if(ierr .eq. 1) go to 12
      print *, ' '
      print *, ' Composite solutions are now supported for hypoellipse', 
     *' files (format number #3)'
...
124     fname2 = aask('name of file with indices', ftemp, -80)
      ...
      print *, '  grid search.  the default increment is 1 degree, but'
      print *, '  it could be increased to speed up the program.  if'
      print *, '  the increment is set greater than 9 degrees, no '
      print *, '  secondary search is done.'
